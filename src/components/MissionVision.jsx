...
<br/><br/><br/>
      ...
      <div className="image-missionsymbol2">
        ...
        <div  ><img className="card-header vision-header" src="images/Vector 5.png"/> <span className="ourvis">Our Vision</span><img src="images/Vector 6.png" className="ourvistringle"/> </div>
